...
export const forgotPassword = async (email) => {
    try {
        const result = await fetch(serverUrl + "/auth/forgotPass", {
            method: "post",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
        ...
        console.log(error)
        return { error: "Error trying to reset password!" }
    }
}

export const resetPassword = async (passwordResetToken, newPassword) => {
    try {
        const result = await fetch(serverUrl + "/auth/resetPass", {
            method: "post",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
